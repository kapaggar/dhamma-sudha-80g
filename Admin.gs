...
function onOpen() {
  ...
  ui.createMenu('80G Admin')
    ...
    .addSubMenu(ui.createMenu('4. WhatsApp Donors')
      .addItem('Send PAN Request (WhatsApp)', 'sendPendingWhatsApp')
      .addItem('Send Test WhatsApp (one number)', 'promptTestWhatsApp')
      .addSeparator()
      .addItem('Enable Hourly WhatsApp Sending', 'installHourlyWhatsAppTrigger')
      .addItem('Disable Hourly WhatsApp Sending', 'disableHourlyWhatsAppTrigger'))
    .addSeparator()
