...
function onOpen() {
  ...
  ui.createMenu('80G Admin')
    ...
    .addSubMenu(ui.createMenu('2. Email Donors')
      ...
      .addSeparator()
      .addItem('Reconcile email_log vs audit_log', 'reconcileEmailLogs'))
    .addSubMenu(ui.createMenu('3. Push PAN to Dana')
      ...
      .addSeparator()
      .addItem('Diagnose a donation_id (field dump)', 'promptDiagnoseDanaWriteBack'))
    .addSubMenu(ui.createMenu('4. WhatsApp Donors')
      .addItem('Send Email Nudge (status_update_2)', 'sendPendingWhatsAppNudge')
      .addItem('Send Test Nudge (one number)', 'promptTestWhatsAppNudge')
      .addItem('Enable Hourly Nudge Sending', 'installHourlyWhatsAppNudgeTrigger')
    ...
    .addSubMenu(ui.createMenu('5. Donation Day')
      .addItem('Enable (3h, every 10 min)', 'enableDonationDayMode')
      .addItem('Disable Now', 'disableDonationDayMode')
      .addItem('Status', 'donationDayStatus'))
    .addSeparator()
